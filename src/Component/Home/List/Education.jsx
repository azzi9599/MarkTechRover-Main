...
const services = [
  {
    ...
    description: "We provide cutting-edge web development services tailored specifically for Education      practices. Our websites are designed to attract new customers, provide essential information, and facilitate online appointments.",
    icon: IoMdCodeWorking,
    color: "#3498db" // Blue
  },
  {
    title: "Education     PPC",
    description: "Our Education     Pay-Per-Click (PPC) services ensure that your Education     practice appears at the top of search engine results. We create targeted ad campaigns that drive traffic and increase patient inquiries.",
    icon: IoMdCash,
    color: "#e74c3c" // Red
  },
  {
  ...
  {
    title: "Education     SEO",
    description: "Our specialized Education     SEO services improve your website's visibility on search engines. We optimize your site with targeted keywords to attract more customers searching for Education     services in your area.",
    icon: IoMdTrendingUp,
    color: "#2ecc71" // Green
  },
  {
  ...
  {
    title: "Education     Social Media Management",
  ...
  {
    title: "Education     Office Training",
    description: "Our Education     Office Training services provide comprehensive training programs to ensure your staff is knowledgeable and efficient in Education     office operations, enhancing patient care and practice management.",
    icon: IoMdSchool,
    color: "#e67e22" // Orange
  },
  {
  ...
  const faqList = [
    {
      question: "What kind of website can Marktechrover create for my Education     practice?",
    ...
    {
      question: "How can SEO benefit my Education     practice?",
    ...
    {
      question: "How can social media marketing help my Education     practice?",
    ...
    <>  
      <div className="h-screen bg-blue-300 flex flex-col justify-center items-center text-center p-4">
        <div className="max-w-2xl">
          <h1 className="text-5xl font-bold text-white mb-4">Education     Online Solutions</h1>
          <p className="text-xl text-white mb-8">“Smile Brighter with Marktechrover’s Digital Solutions for Education     Clinics”</p>
          <img src="" alt="Education     Banner" className="w-full h-auto " />
        </div>
      </div>
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        <div className="w-full flex flex-col items-center p-4">
          <h1 className="text-5xl font-bold text-center mb-4">Education     Marketing With A Guarantee</h1>
          ...
          <p className='text-xl p-4'>If our Education     digital marketing services don't deliver results within the first 30 days, we won't charge you a single penny, guaranteed.</p>
        </div>
        <div className="">
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        ...
        <div className="w-full flex flex-col items-center p-4">
          <h1 className="text-5xl font-bold text-center mb-4">An End-To-End Education     Marketing Company</h1>
          <p className='text-xl p-4'>Education     offices seeking digital marketing services need a provider that covers every aspect of their business.
          ...
          <p className='text-xl p-4'>Our digital marketing for Education     practices provides a host of features including the design of a new or updated website.
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        <div className="w-full flex flex-col items-center p-4">
          <h1 className="text-5xl font-bold text-center mb-4">Go Beyond Digital Marketing for Your Education     Clinic</h1>
          <p className='text-xl p-4'>Online review generation and reputation management is a vital part
            of digital marketing for Education     clinics. MarkTechrover creates a user-friendly application  
          ...
          <p className='text-xl p-4'>Take control of your review process and start generating the 5 star reviews you need
            and quickly address negative feedback right away with this intuitive Education     clinic digital marketing tool.</p>
      ...
      <div className="bg-blue-50 py-16 p-16">
        <div className="container mx-auto">
          <h1 className="text-5xl font-bold text-center mb-16 ">Education     Marketing Services</h1>
      ...
      {/* STEPS TO IMPLEMENT A Education     MARKETING STRATEGY */}

     <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8  ">
      <h1 className='text-center text-5xl font-bold m-4 mb-16 rounded-sm'>Steps to Implement a Education     Marketing Strategy</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16  ml-10 mr-10">
        <div className="md:col-span-2 space-y-12 ">
          ...
          <p className="mb-4">
            Growing urbanization makes the small-town model less financially viable and potential customers are relying less upon the recommendation of family and friends in the Education     business and more on online reputations. Yelp, Facebook, and Google+ reviews can determine a potential patient’s opinion, but so can other online marketing factors from ranking to a website’s user experience.
          </p>
          <p className="mb-4">
            This is why Education     SEO services are imperative to stay competitive, and Coalition Technologies is here to help. We can help you build relationships with new marketplaces in order to increase the number of loyal clients your practice serves.
          </p>
          <p className="mb-4">
