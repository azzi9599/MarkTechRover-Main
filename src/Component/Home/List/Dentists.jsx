...
import DentalMarketing from '../../assets/DentalMarketing.png';
...
const services = [
  {
    ...
    description: "We provide cutting-edge web development services tailored specifically for dental practices. Our websites are designed to attract new patients, provide essential information, and facilitate online appointments.",
    icon: IoMdCodeWorking,
    color: "#3498db" // Blue
  },
  {
    title: "Dental PPC",
    description: "Our Dental Pay-Per-Click (PPC) services ensure that your dental practice appears at the top of search engine results. We create targeted ad campaigns that drive traffic and increase patient inquiries.",
    icon: IoMdCash,
    color: "#e74c3c" // Red
  },
  {
  ...
  {
    title: "Dental SEO",
    description: "Our specialized Dental SEO services improve your website's visibility on search engines. We optimize your site with targeted keywords to attract more patients searching for dental services in your area.",
    icon: IoMdTrendingUp,
    color: "#2ecc71" // Green
  },
  {
  ...
  {
    title: "Dental Social Media Management",
  ...
  {
    title: "Dental Office Training",
    description: "Our Dental Office Training services provide comprehensive training programs to ensure your staff is knowledgeable and efficient in dental office operations, enhancing patient care and practice management.",
    icon: IoMdSchool,
    color: "#e67e22" // Orange
  },
  {
  ...
  const faqList = [
    {
      question: "What kind of website can Marktechrover create for my dental practice?",
    ...
    {
      question: "How can SEO benefit my dental practice?",
    ...
    {
      question: "How can social media marketing help my dental practice?",
    ...
    <>  
      <div className="h-screen bg-blue-300 flex flex-col justify-center items-center text-center p-4">
        <div className="max-w-2xl">
          <h1 className="text-5xl font-bold text-white mb-4">Dental Online Solutions</h1>
          <p className="text-xl text-white mb-8">“Smile Brighter with Marktechrover’s Digital Solutions for Dental Clinics”</p>
          <img src={Banner} alt="Dental Banner" className="w-full h-auto " />
        </div>
      </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={Feedback} alt="Client 1" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Dental Firm</h2>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={Feedback} alt="Client 2" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Dental Firm</h2>
                <p className="text-gray-700">"We've seen a significant increase in client inquiries and website traffic."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={Feedback} alt="Client 3" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Dental Firm</h2>
                <p className="text-gray-700">"Their expertise in pet care marketing is unmatched. Highly recommend!"</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={Feedback} alt="Client 4" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Dental Firm</h2>
                <p className="text-gray-700">"Our online presence has improved dramatically thanks to their comprehensive marketing strategy."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={Feedback} alt="Client 5" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Dental Firm</h2>
                <p className="text-gray-700">"We've seen a significant increase in client inquiries and website traffic."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={Feedback} alt="Client 6" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Dental Firm</h2>
                <p className="text-gray-700">"Their expertise in pet care marketing is unmatched. Highly recommend!"</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={Feedback} alt="Client 7" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Dental Firm</h2>
                <p className="text-gray-700">"Our online presence has improved dramatically thanks to their comprehensive marketing strategy."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={Feedback} alt="Client 8" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Dental Firm</h2>
                <p className="text-gray-700">"We've seen a significant increase in client inquiries and website traffic."</p>
              </div>
            </div>
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        ...
        <div className="">
          <img src={DentalMarketing} alt="Rainbow Dental" />
        </div>
      </div>
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        <div className="w-full flex items-center justify-center">
          <img src={EndToEnd} alt="Rainbow Dental" />
        </div>
        <div className="w-full flex flex-col items-center p-4">
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        ...
        <div className="w-full flex items-center justify-center">
          <img src={Feedback} alt="Rainbow Dental" />
        </div>
      </div>
      ...
      <div className="bg-blue-50 py-16 p-16">
        <div className="container mx-auto">
          <h1 className="text-5xl font-bold text-center mb-16 ">Dental Marketing Services</h1>
