...
import houseSearch from '../../assets/HouseSearching.png';
...
const services = [
  {
    ...
    description: "We offer state-of-the-art web development services tailored for real estate agencies. Our websites are designed to attract potential buyers, showcase property listings, and facilitate online inquiries.",
    icon: IoMdCodeWorking,
    color: "#3498db" // Blue
  },
  {
    title: "Real Estate PPC",
    description: "Our Real Estate Pay-Per-Click (PPC) services ensure that your listings appear at the top of search engine results. We create targeted ad campaigns that drive traffic and generate leads.",
    icon: IoMdCash,
    color: "#e74c3c" // Red
  },
  {
    title: "Online Review Generation",
    description: "We help you build and manage a positive online reputation by generating authentic reviews from your clients. Our strategies ensure that your agency stands out with stellar reviews.",
    icon: IoMdStar,
    color: "#f1c40f" // Yellow
  },
  {
    title: "Real Estate SEO",
    description: "Our specialized Real Estate SEO services improve your website's visibility on search engines. We optimize your site with targeted keywords to attract more potential buyers searching for properties.",
    icon: IoMdTrendingUp,
    color: "#2ecc71" // Green
  },
  {
    title: "Reputation Management",
    description: "Our reputation management services help you maintain a positive online presence. We monitor reviews, respond to feedback, and implement strategies to enhance your agency's reputation.",
  ...
  {
    title: "Real Estate Agent Training",
    description: "Our Real Estate Agent Training services provide comprehensive training programs to ensure your staff is knowledgeable and efficient in real estate operations, enhancing client service and agency management.",
    icon: IoMdSchool,
    color: "#e67e22" // Orange
  },
  {
...
const faqList = [
  {
    question: "What kind of website can you create for my real estate agency?",
    answer: "We design and develop user-friendly websites tailored to your agency. The website will showcase your property listings, facilitate online inquiries, and provide valuable client information. It will also be optimized for search engines to improve visibility."
  },
  {
    question: "How can SEO benefit my real estate agency?",
    answer: "SEO helps improve your website's visibility on search engines, making it easier for potential clients to find you. This can lead to increased traffic and more inquiries."
  },
  {
    question: "What is the importance of online reviews for my agency?",
    answer: "Online reviews build trust and credibility. Positive reviews can attract more clients, while addressing negative feedback can improve your agency's reputation."
  },
  {
    question: "How can social media marketing help my real estate agency?",
    answer: "Social media marketing helps you connect with your community, share valuable content, and attract new clients. It can also enhance your agency's online presence and reputation."
  },
  {
    question: "What is PPC advertising and how does it work for real estate?",
  ...
  return (
    <div>
      <>
        <div className="h-screen bg-blue-300 flex flex-col justify-center items-center text-center p-4">
          <div className="max-w-2xl">
            <h1 className="text-5xl font-bold text-white mb-4">Real Estate Online Solutions</h1>
            <p className="text-xl text-white mb-8">“Find Your Dream Home with Our Digital Solutions for Real Estate Agencies”</p>
            <img src="" alt="Real Estate Banner" className="w-full h-auto" />
          </div>
        </div>
         ...
         <div className="py-16 p-16">
          <div className="container mx-auto">
            <h1 className="text-5xl font-bold text-center mb-16">Our Resent Works</h1>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={houseSearch} alt="Client 1" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Riverside Realty</h2>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={houseSearch} alt="Client 2" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Urban Living Group</h2>
                <p className="text-gray-700">"We've seen a significant increase in client inquiries and website traffic."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={houseSearch} alt="Client 3" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Lakeside Properties</h2>
                <p className="text-gray-700">"Their expertise in real estate marketing is unmatched. Highly recommend!"</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={houseSearch} alt="Client 1" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Riverside Realty</h2>
        ...
        <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4">Real Estate Marketing With A Guarantee</h1>
            <p className="text-xl p-4">In the competitive real estate market, guarantees are rare. But our digital marketing for real estate agencies stands out. We understand the importance of earning your trust.</p>
            <p className="text-xl p-4">If our real estate digital marketing services don't deliver results within the first 30 days, we won't charge you a single penny, guaranteed.</p>
          </div>
          <div>
            <img src={houseSearch} alt="Real Estate Marketing" />
          </div>
        </div>
        ...
        <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex items-center justify-center">
            <img src={houseSearch} alt="End-To-End Service" />
          </div>
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4">An End-To-End Real Estate Marketing Company</h1>
            <p className="text-xl p-4">Real estate agencies need a provider that covers every aspect of their business. We assign you a dedicated Account Manager to establish goals and develop a timeline to reach them.</p>
            <p className="text-xl p-4">Our digital marketing services provide a host of features including the design of a new or updated website. Our expert web designers, graphic artists, and content writers will design, build, and launch your custom website complete with fully optimized, eye-catching content that looks great on any device.</p>
          </div>
        </div>
        ...
        <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4">Go Beyond Digital Marketing for Your Real Estate Agency</h1>
            <p className="text-xl p-4">Online review generation and reputation management is a vital part of digital marketing for real estate agencies. We create a user-friendly application to help you manage your online reputation like never before.</p>
            <p className="text-xl p-4">Take control of your review process and start generating the 5-star reviews you need and quickly address negative feedback right away with this intuitive real estate digital marketing tool.</p>
          </div>
          <div className="w-full flex items-center justify-center">
            <img src={houseSearch} alt="Feedback Management" />
          </div>
        </div>
        ...
        <div className="bg-blue-50 py-16 p-16">
          <div className="container mx-auto">
            <h1 className="text-5xl font-bold text-center mb-16">Real Estate Marketing Services</h1>
     ...
     <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8  ">
      <h1 className='text-center text-5xl font-bold m-4 mb-16 rounded-sm'>Steps to Implement a Real Estate Marketing Strategy</h1>
      ...
      <div className="flex flex-col lg:flex-row justify-evenly items-center gap-8 mt-10 mb-10">
        ...
        <h1 className="text-center text-5xl font-bold mb-10">Real Estate Marketing FAQs</h1>
