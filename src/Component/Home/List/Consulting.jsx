...
import consultingImage from '../../assets/ConsultingImage.png'; // Replace with the correct path to your consulting image

import Footer from '../Footer';

const services = [
  {
    title: "Consulting Web Development",
    description: "We provide top-notch web development services tailored for consulting businesses. Our websites are designed to attract potential clients, showcase services, and facilitate online interactions.",
    icon: IoMdCodeWorking,
    color: "#3498db" // Blue
  },
  {
    title: "Consulting PPC",
    description: "Our Pay-Per-Click (PPC) services ensure that your consulting business appears at the top of search engine results. We create targeted ad campaigns that drive traffic and generate leads.",
    icon: IoMdCash,
    color: "#e74c3c" // Red
  },
  {
  ...
  },
  {
    ...
    description: "Our specialized SEO services improve your website's visibility on search engines. We optimize your site with targeted keywords to attract more potential clients searching for consulting services.",
    icon: IoMdTrendingUp,
    color: "#2ecc71" // Green
  },
  {
  ...
  {
    title: "Consulting Staff Training",
    description: "Our Staff Training services provide comprehensive training programs to ensure your team is knowledgeable and efficient in consulting operations, enhancing client service and business management.",
    icon: IoMdSchool,
    color: "#e67e22" // Orange
  },
  {
...
const faqList = [
  {
    question: "What kind of website can you create for my consulting business?",
    answer: "We design and develop user-friendly websites tailored to your business. The website will showcase your services, facilitate online interactions, and provide valuable client information. It will also be optimized for search engines to improve visibility."
  },
  {
    question: "How can SEO benefit my consulting business?",
  ...
  {
    question: "How can social media marketing help my consulting business?",
  ...
  {
    question: "What is PPC advertising and how does it work for consulting?",
...
const Consulting = () => {
  ...
  return (
    <>
     <div className="h-screen bg-green-300 flex flex-col justify-center items-center text-center p-4">
          <div className="max-w-2xl">
            <h1 className="text-5xl font-bold text-white mb-4">Consulting Firm Online Solutions</h1>
            <p className="text-xl text-white mb-8">“Ensure the Best Care for Your Pets with Our Digital Solutions for Consulting Firm Businesses”</p>
            <img src="" alt="Consulting Firm Banner" className="w-full h-auto" />
          </div>
        </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={consultingImage} alt="Client 1" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Consulting Firm 1</h2>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={consultingImage} alt="Client 2" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Consulting Firm 1</h2>
                <p className="text-gray-700">"We've seen a significant increase in client inquiries and website traffic."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={consultingImage} alt="Client 3" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Consulting Firm 1</h2>
                <p className="text-gray-700">"Their expertise in Consulting Firm marketing is unmatched. Highly recommend!"</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={consultingImage} alt="Client 4" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Consulting Firm 1</h2>
                <p className="text-gray-700">"Our online presence has improved dramatically thanks to their comprehensive marketing strategy."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={consultingImage} alt="Client 5" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Consulting Firm 1</h2>
                <p className="text-gray-700">"We've seen a significant increase in client inquiries and website traffic."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={consultingImage} alt="Client 6" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Consulting Firm 1</h2>
                <p className="text-gray-700">"Their expertise in Consulting Firm marketing is unmatched. Highly recommend!"</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={consultingImage} alt="Client 7" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Consulting Firm 1</h2>
                <p className="text-gray-700">"Our online presence has improved dramatically thanks to their comprehensive marketing strategy."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={consultingImage} alt="Client 8" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Consulting Firm 1</h2>
                <p className="text-gray-700">"We've seen a significant increase in client inquiries and website traffic."</p>
              </div>
            </div>
        ...
        <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4"> Consulting Firm  Marketing With A Guarantee</h1>
            <p className="text-xl p-4">In the competitive Consulting Firm industry, guarantees are rare. But our digital marketing for Consulting Firm companies stands out. We understand the importance of earning your trust.</p>
            <p className="text-xl p-4">If our Consulting Firm  digital marketing services don't deliver results within the first 30 days, we won't charge you a single penny, guaranteed.</p>
          </div>
          <div>
            <img src={consultingImage} alt="Consulting Firm Marketing" />
          </div>
        </div>
        ...
        <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex items-center justify-center">
            <img src={consultingImage} alt="End-To-End Service" />
          </div>
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4">An End-To-End Consulting Firm Marketing Company</h1>
            <p className="text-xl p-4">Consulting Firm agencies need a provider that covers every aspect of their business. We assign you a dedicated Account Manager to establish goals and develop a timeline to reach them.</p>
        ...
        <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4">Go Beyond Digital Marketing for Your Consulting Firm Business</h1>
            <p className="text-xl p-4">Online review generation and reputation management is a vital part of digital marketing for Consulting Firm agencies. We create a user-friendly application to help you manage your online reputation like never before.</p>
            <p className="text-xl p-4">Take control of your review process and start generating the 5-star reviews you need and quickly address negative feedback right away with this intuitive Consulting Firm digital marketing tool.</p>
          </div>
          <div className="w-full flex items-center justify-center">
            <img src={consultingImage} alt="Feedback Management" />
          </div>
        </div>
        ...
        <div className="bg-blue-50 py-16 p-16">
          <div className="container mx-auto">
            <h1 className="text-5xl font-bold text-center mb-16">Consulting Marketing Services</h1>
     ...
     <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8  ">
      <h1 className='text-center text-5xl font-bold m-4 mb-16 rounded-sm'>Steps to Implement a Consulting Firm Marketing Strategy</h1>
     ...
     <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8  ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16  ml-10 mr-10">
        ...
        {/* FAQ Section */}
        <div className="h-screen p-16 mt-8">
        <h1 className="text-center text-5xl font-bold mb-10">Consulting Marketing FAQs</h1>
