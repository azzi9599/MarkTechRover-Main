...
const services = [
  {
    title: "  Gym Web Development",
    description: "We provide cutting-edge web development services tailored specifically for   Gym practices. Our websites are designed to attract new patients, provide essential information, and facilitate online appointments.",
    icon: IoMdCodeWorking,
    color: "#3498db" // Blue
  },
  {
    title: "  Gym PPC",
    description: "Our   Gym Pay-Per-Click (PPC) services ensure that your   Gym practice appears at the top of search engine results. We create targeted ad campaigns that drive traffic and increase patient inquiries.",
    icon: IoMdCash,
    color: "#e74c3c" // Red
  },
  {
  ...
  {
    title: "  Gym SEO",
    description: "Our specialized   Gym SEO services improve your website's visibility on search engines. We optimize your site with targeted keywords to attract more patients searching for   Gym services in your area.",
    icon: IoMdTrendingUp,
    color: "#2ecc71" // Green
  },
  {
  ...
  {
    title: "  Gym Social Media Management",
  ...
  {
    title: "  Gym Office Training",
    description: "Our   Gym Office Training services provide comprehensive training programs to ensure your staff is knowledgeable and efficient in   Gym office operations, enhancing patient care and practice management.",
    icon: IoMdSchool,
    color: "#e67e22" // Orange
  },
  {
  ...
  const faqList = [
    {
      question: "What kind of website can Marktechrover create for my   Gym practice?",
    ...
    {
      question: "How can SEO benefit my   Gym practice?",
    ...
    {
      question: "How can social media marketing help my   Gym practice?",
...
const MainDentist = () => {
    ...
    <>  
      <div className="h-screen bg-blue-300 flex flex-col justify-center items-center text-center p-4">
        <div className="max-w-2xl">
          <h1 className="text-5xl font-bold text-white mb-4">Gym Online Solutions</h1>
          <p className="text-xl text-white mb-8">“Smile Brighter with Marktechrover’s Digital Solutions for   Gym  ”</p>
          <img src="" alt="  Gym Banner" className="w-full h-auto " />
        </div>
      </div>
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        <div className="w-full flex flex-col items-center p-4">
          <h1 className="text-5xl font-bold text-center mb-4">  Gym Marketing With A Guarantee</h1>
          ...
          <p className='text-xl p-4'>If our   Gym digital marketing services don't deliver results within the first 30 days, we won't charge you a single penny, guaranteed.</p>
        </div>
        <div className="">
          <img src="" alt="Rainbow   Gym" />
        </div>
      </div>
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        ...
        <div className="w-full flex flex-col items-center p-4">
          <h1 className="text-5xl font-bold text-center mb-4">An End-To-End   Gym Marketing Company</h1>
          <p className='text-xl p-4'>  Gym offices seeking digital marketing services need a provider that covers every aspect of their business.
          ...
          <p className='text-xl p-4'>Our digital marketing for   Gym practices provides a host of features including the design of a new or updated website.
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        <div className="w-full flex flex-col items-center p-4">
          <h1 className="text-5xl font-bold text-center mb-4">Go Beyond Digital Marketing for Your   Gym Clinic</h1>
          <p className='text-xl p-4'>Online review generation and reputation management is a vital part
            of digital marketing for   Gym  . MarkTechrover creates a user-friendly application  
          ...
          <p className='text-xl p-4'>Take control of your review process and start generating the 5 star reviews you need
            and quickly address negative feedback right away with this intuitive   Gym clinic digital marketing tool.</p>
      ...
      <div className="bg-blue-50 py-16 p-16">
        <div className="container mx-auto">
          <h1 className="text-5xl font-bold text-center mb-16 ">  Gym Marketing Services</h1>
      ...
      {/* STEPS TO IMPLEMENT A   Gym MARKETING STRATEGY */}

     <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8  ">
      <h1 className='text-center text-5xl font-bold m-4 mb-16 rounded-sm'>Steps to Implement a   Gym Marketing Strategy</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16  ml-10 mr-10">
        <div className="md:col-span-2 space-y-12 ">
          ...
          <p className="mb-4">
            Growing urbanization makes the small-town model less financially viable and potential patients are relying less upon the recommendation of family and friends in the   Gym business and more on online reputations. Yelp, Facebook, and Google+ reviews can determine a potential patient’s opinion, but so can other online marketing factors from ranking to a website’s user experience.
          </p>
          <p className="mb-4">
            This is why   Gym SEO services are imperative to stay competitive, and Coalition Technologies is here to help. We can help you build relationships with new marketplaces in order to increase the number of loyal clients your practice serves.
          </p>
          <p className="mb-4">
      ...
      <div className="flex flex-col lg:flex-row justify-evenly items-center gap-8 mt-10 mb-10">
        ...
        <div className="w-full lg:w-1/3 bg-white rounded-lg shadow-lg hover:scale-105 transition text-center p-6">
          ...
          <p className="text-gray-600">Rainbow   Gym</p>
        </div>
  ...
  <h1 className="text-center text-5xl font-bold mb-10">  Gym Marketing FAQs</h1>
