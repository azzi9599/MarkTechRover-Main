...
const services = [
  {
    ...
    description: "We offer state-of-the-art web development services tailored for healthcare providers. Our websites are designed to attract potential patients, showcase services, and facilitate online appointments.",
    icon: IoMdCodeWorking,
    color: "#3498db" // Blue
  },
  {
    title: "Healthcare PPC",
    description: "Our Healthcare Pay-Per-Click (PPC) services ensure that your practice appears at the top of search engine results. We create targeted ad campaigns that drive traffic and generate leads.",
    icon: IoMdCash,
    color: "#e74c3c" // Red
  },
  {
    title: "Online Review Generation",
    description: "We help you build and manage a positive online reputation by generating authentic reviews from your patients. Our strategies ensure that your practice stands out with stellar reviews.",
    icon: IoMdStar,
    color: "#f1c40f" // Yellow
  },
  {
    title: "Healthcare SEO",
    description: "Our specialized Healthcare SEO services improve your website's visibility on search engines. We optimize your site with targeted keywords to attract more potential patients searching for healthcare services.",
    icon: IoMdTrendingUp,
    color: "#2ecc71" // Green
  },
  {
  ...
  },
  {
    ...
    description: "Our Healthcare Staff Training services provide comprehensive training programs to ensure your staff is knowledgeable and efficient in healthcare operations, enhancing patient service and practice management.",
    icon: IoMdSchool,
    color: "#e67e22" // Orange
  },
  {
...
const faqList = [
  {
    question: "What kind of website can you create for my healthcare practice?",
  ...
  {
    question: "How can SEO benefit my healthcare practice?",
  ...
  {
    question: "How can social media marketing help my healthcare practice?",
  ...
  {
    question: "What is PPC advertising and how does it work for healthcare?",
    ...
    <>
      <div className="h-screen bg-blue-300 flex flex-col justify-center items-center text-center p-4">
        <div className="max-w-2xl">
          <h1 className="text-5xl font-bold text-white mb-4">Healthcare Online Solutions</h1>
          <p className="text-xl text-white mb-8">“Ensure the Best Care for Your Patients with Our Digital Solutions for Healthcare Providers”</p>
          <img src= "" alt="Healthcare Banner" className="w-full h-auto" />
        </div>
      </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
              ...
              <h2 className="text-2xl font-bold mb-2">Happy Health Clinic</h2>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
              ...
              <h2 className="text-2xl font-bold mb-2">Urban Health Care</h2>
              <p className="text-gray-700">"We've seen a significant increase in patient inquiries and website traffic."</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
              <img src="" alt="Client 3" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
              <h2 className="text-2xl font-bold mb-2">Lakeside Health Services</h2>
              <p className="text-gray-700">"Their expertise in healthcare marketing is unmatched. Highly recommend!"</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
              <img src="" alt="Client 4" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
              <h2 className="text-2xl font-bold mb-2">Country Side Health Care</h2>
              <p className="text-gray-700">"Our online presence has improved dramatically thanks to their comprehensive marketing strategy."</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
              <img src="" alt="Client 5" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
              <h2 className="text-2xl font-bold mb-2">City Health Clinic</h2>
              <p className="text-gray-700">"We've seen a significant increase in patient inquiries and website traffic."</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
              <img src="" alt="Client 6" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
              <h2 className="text-2xl font-bold mb-2">Riverside Health Services</h2>
              <p className="text-gray-700">"Their expertise in healthcare marketing is unmatched. Highly recommend!"</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
              <img src="" alt="Client 7" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
              <h2 className="text-2xl font-bold mb-2">Downtown Health Care</h2>
              <p className="text-gray-700">"Our online presence has improved dramatically thanks to their comprehensive marketing strategy."</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
              <img src="" alt="Client 8" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
              <h2 className="text-2xl font-bold mb-2">Suburban Health Clinic</h2>
              <p className="text-gray-700">"We've seen a significant increase in patient inquiries and website traffic."</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4">Health Care Marketing With A Guarantee</h1>
            <p className="text-xl p-4">In the competitive health Caremarketing, guarantees are rare. But our digital marketing for health Careagencies stands out. We understand the importance of earning your trust.</p>
            <p className="text-xl p-4">If our health Caredigital marketing services don't deliver results within the first 30 days, we won't charge you a single penny, guaranteed.</p>
          </div>
          <div>
            <img src="" alt="health CareMarketing" />
          </div>
        </div>
        ...
        <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex items-center justify-center">
            <img src="" alt="End-To-End Service" />
          </div>
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4">An End-To-End health CareMarketing Company</h1>
            <p className="text-xl p-4">health Careagencies need a provider that covers every aspect of their business. We assign you a dedicated Account Manager to establish goals and develop a timeline to reach them.</p>
        ...
        <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4">Go Beyond Digital Marketing for Your health CareAgency</h1>
            <p className="text-xl p-4">Online review generation and reputation management is a vital part of digital marketing for health Careagencies. We create a user-friendly application to help you manage your online reputation like never before.</p>
            <p className="text-xl p-4">Take control of your review process and start generating the 5-star reviews you need and quickly address negative feedback right away with this intuitive health Caredigital marketing tool.</p>
          </div>
          <div className="w-full flex items-center justify-center">
            <img src="" alt="Feedback Management" />
          </div>
        </div>


      {/* Our Services Section */}
      <div className="py-16 p-16 bg-blue-100">
        <div className="container mx-auto">
          <h1 className="text-5xl font-bold text-center mb-16">Our Services</h1>
          <div className="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 xl:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm hover:scale-105 transition">
                <div className="text-center mb-4">
                  <service.icon className="text-6xl" style={{ color: service.color }} />
                </div>
     ...
     <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8  ">
      <h1 className='text-center text-5xl font-bold m-4 mb-16 rounded-sm'>Steps to Implement a Health Care Marketing Strategy</h1>
      ...
      <div className="flex flex-col lg:flex-row justify-evenly items-center gap-8 mt-10 mb-10">
       ...
       {/* FAQ Section */}
       <div className="h-screen p-16 mt-6">
        <h1 className="text-center text-5xl font-bold mb-10">Health Care Marketing FAQs</h1>
