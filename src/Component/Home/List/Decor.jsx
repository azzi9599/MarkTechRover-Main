...
const services = [
  {
    title: "Home Decors     Web Development",
    description: "We provide cutting-edge web development services tailored specifically for Home Decors      practices. Our websites are designed to attract new customers, provide essential information, and facilitate online appointments.",
    icon: IoMdCodeWorking,
    color: "#3498db" // Blue
  },
  {
    title: "Home Decors     PPC",
    description: "Our Home Decors     Pay-Per-Click (PPC) services ensure that your Home Decors     practice appears at the top of search engine results. We create targeted ad campaigns that drive traffic and increase patient inquiries.",
    icon: IoMdCash,
    color: "#e74c3c" // Red
  },
  {
    title: "Online Review Generation",
    description: "We help you build and manage a positive online reputation by generating authentic reviews from your satisfied customers. Our strategies ensure that your practice stands out with stellar reviews.",
    icon: IoMdStar,
    color: "#f1c40f" // Yellow
  },
  {
    title: "Home Decors     SEO",
    description: "Our specialized Home Decors     SEO services improve your website's visibility on search engines. We optimize your site with targeted keywords to attract more customers searching for Home Decors     services in your area.",
    icon: IoMdTrendingUp,
    color: "#2ecc71" // Green
  },
  {
  ...
  {
    title: "Home Decors     Social Media Management",
  ...
  {
    title: "Home Decors     Office Training",
    description: "Our Home Decors     Office Training services provide comprehensive training programs to ensure your staff is knowledgeable and efficient in Home Decors     office operations, enhancing patient care and practice management.",
    icon: IoMdSchool,
    color: "#e67e22" // Orange
  },
  {
    title: "Call Tracking",
    description: "Our Call Tracking services help you monitor and analyze phone calls from potential customers. This allows you to measure the effectiveness of your marketing campaigns and improve patient communication.",
    icon: IoMdCall,
    color: "#1abc9c" // Teal
  },
];
  ...
  const faqList = [
    {
      question: "What kind of website can Marktechrover create for my Home Decors     practice?",
    ...
    {
      question: "How can SEO benefit my Home Decors     practice?",
      answer: "SEO helps improve your website's visibility on search engines, making it easier for potential customers to find you. This can lead to increased traffic and more appointments."
    },
    {
      question: "What is the importance of online reviews for my practice?",
      answer: "Online reviews build trust and credibility. Positive reviews can attract more customers, while addressing negative feedback can improve your practice's reputation."
    },
    {
      question: "How can social media marketing help my Home Decors     practice?",
      answer: "Social media marketing helps you connect with your community, share valuable content, and attract new customers. It can also enhance your practice's online presence and reputation."
    },
    {
    ...
    <>  
      <div className="h-screen bg-blue-300 flex flex-col justify-center items-center text-center p-4">
        <div className="max-w-2xl">
          <h1 className="text-5xl font-bold text-white mb-4">Home Decors     Online Solutions</h1>
          <p className="text-xl text-white mb-8">“Smile Brighter with Marktechrover’s Digital Solutions for Home Decors     Clinics”</p>
          <img src="" alt="Home Decors     Banner" className="w-full h-auto " />
        </div>
      </div>
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        <div className="w-full flex flex-col items-center p-4">
          <h1 className="text-5xl font-bold text-center mb-4">Home Decors     Marketing With A Guarantee</h1>
          ...
          <p className='text-xl p-4'>If our Home Decors     digital marketing services don't deliver results within the first 30 days, we won't charge you a single penny, guaranteed.</p>
        </div>
        <div className="">
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        ...
        <div className="w-full flex flex-col items-center p-4">
          <h1 className="text-5xl font-bold text-center mb-4">An End-To-End Home Decors     Marketing Company</h1>
          <p className='text-xl p-4'>Home Decors     offices seeking digital marketing services need a provider that covers every aspect of their business.
          ...
          <p className='text-xl p-4'>Our digital marketing for Home Decors     practices provides a host of features including the design of a new or updated website.
      ...
      <div className="flex ml-20 mr-20 gap-10 mt-10">
        <div className="w-full flex flex-col items-center p-4">
          <h1 className="text-5xl font-bold text-center mb-4">Go Beyond Digital Marketing for Your Home Decors     Clinic</h1>
          <p className='text-xl p-4'>Online review generation and reputation management is a vital part
            of digital marketing for Home Decors     clinics. MarkTechrover creates a user-friendly application  
          ...
          <p className='text-xl p-4'>Take control of your review process and start generating the 5 star reviews you need
            and quickly address negative feedback right away with this intuitive Home Decors     clinic digital marketing tool.</p>
      ...
      {/* Home Decors     Marketing Services */}
      <div className="bg-blue-50 py-16 p-16">
        <div className="container mx-auto">
          <h1 className="text-5xl font-bold text-center mb-16 ">Home Decors     Marketing Services</h1>
      ...
      {/* STEPS TO IMPLEMENT A Home Decors     MARKETING STRATEGY */}

     <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8  ">
      <h1 className='text-center text-5xl font-bold m-4 mb-16 rounded-sm'>Steps to Implement a Home Decors     Marketing Strategy</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16  ml-10 mr-10">
        <div className="md:col-span-2 space-y-12 ">
          ...
          <p className="mb-4">
            Growing urbanization makes the small-town model less financially viable and potential customers are relying less upon the recommendation of family and friends in the Home Decors     business and more on online reputations. Yelp, Facebook, and Google+ reviews can determine a potential patient’s opinion, but so can other online marketing factors from ranking to a website’s user experience.
          </p>
          <p className="mb-4">
            This is why Home Decors     SEO services are imperative to stay competitive, and Coalition Technologies is here to help. We can help you build relationships with new marketplaces in order to increase the number of loyal clients your practice serves.
          </p>
          <p className="mb-4">
      ...
      <div className="flex flex-col lg:flex-row justify-evenly items-center gap-8 mt-10 mb-10">
        <div className="w-full lg:w-1/3 bg-white rounded-lg shadow-lg text-center p-6 hover:scale-105 transition" >
          <p className="italic p-2 text-gray-700">
            ...
            attracting more customers. The engaging content they create positions
        ...
        <div className="w-full lg:w-1/3 bg-white rounded-lg shadow-lg hover:scale-105 transition text-center p-6">
          <p className="italic p-2 text-gray-700">
            ...
            easy for our customers. Their SEO expertise, engaging content
            creation, and effective social media marketing have resulted in a
            noticeable increase in new customers. Their paid advertising
        ...
        <div className="w-full lg:w-1/3 bg-white rounded-lg hover:scale-105 transition shadow-lg text-center p-6">
          <p className="italic p-2 text-gray-700">
            ...
            attracting new customers. We highly value their ongoing support and
