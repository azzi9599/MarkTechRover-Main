...
const services = [
  {
    title: "Pet Care Web Development",
    description: "We offer state-of-the-art web development services tailored for pet care businesses. Our websites are designed to attract potential clients, showcase services, and facilitate online bookings.",
    icon: IoMdCodeWorking,
    color: "#3498db" // Blue
  },
  {
    title: "Pet Care PPC",
    description: "Our Pet Care Pay-Per-Click (PPC) services ensure that your business appears at the top of search engine results. We create targeted ad campaigns that drive traffic and generate leads.",
    icon: IoMdCash,
    color: "#e74c3c" // Red
  },
  {
  ...
  {
    title: "Pet Care SEO",
    description: "Our specialized Pet Care SEO services improve your website's visibility on search engines. We optimize your site with targeted keywords to attract more potential clients searching for pet care services.",
    icon: IoMdTrendingUp,
    color: "#2ecc71" // Green
  },
  {
  ...
  {
    title: "Pet Care Social Media Management",
  ...
  {
    title: "Pet Care Staff Training",
    description: "Our Pet Care Staff Training services provide comprehensive training programs to ensure your staff is knowledgeable and efficient in pet care operations, enhancing client service and business management.",
    icon: IoMdSchool,
    color: "#e67e22" // Orange
  },
  {
...
const faqList = [
  {
    question: "What kind of website can you create for my pet care business?",
  ...
  {
    question: "How can SEO benefit my pet care business?",
  ...
  {
    question: "How can social media marketing help my pet care business?",
  ...
  {
    question: "What is PPC advertising and how does it work for pet care?",
    ...
    <>
     <div className="h-screen bg-green-300 flex flex-col justify-center items-center text-center p-4">
          <div className="max-w-2xl">
            <h1 className="text-5xl font-bold text-white mb-4">Pet Care Online Solutions</h1>
            <p className="text-xl text-white mb-8">“Ensure the Best Care for Your Pets with Our Digital Solutions for Pet Care Businesses”</p>
            <img src="" alt="Pet Care Banner" className="w-full h-auto" />
          </div>
        </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={petcare} alt="Client 1" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={petcare} alt="Client 2" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={petcare} alt="Client 3" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={petcare} alt="Client 4" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Country Side Pet Care</h2>
                <p className="text-gray-700">"Our online presence has improved dramatically thanks to their comprehensive marketing strategy."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={petcare} alt="Client 5" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">City Pet Clinic</h2>
                <p className="text-gray-700">"We've seen a significant increase in client inquiries and website traffic."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={petcare} alt="Client 6" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Riverside Pet Services</h2>
                <p className="text-gray-700">"Their expertise in pet care marketing is unmatched. Highly recommend!"</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={petcare} alt="Client 7" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
                <h2 className="text-2xl font-bold mb-2">Downtown Pet Care</h2>
                <p className="text-gray-700">"Our online presence has improved dramatically thanks to their comprehensive marketing strategy."</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm text-center hover:scale-105 transition">
                <img src={petcare} alt="Client 8" className="w-32 h-32 mx-auto mb-4 rounded-full object-cover" />
        ...
        <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4">Pet Care  Marketing With A Guarantee</h1>
            <p className="text-xl p-4">In the competitive pet care industry, guarantees are rare. But our digital marketing for pet care companies stands out. We understand the importance of earning your trust.</p>
            <p className="text-xl p-4">If our pet care  digital marketing services don't deliver results within the first 30 days, we won't charge you a single penny, guaranteed.</p>
          </div>
          <div>
            <img src={petcare} alt="Pet Care Marketing" />
          </div>
        </div>
        ...
        <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex items-center justify-center">
            <img src={petcare} alt="End-To-End Service" />
          </div>
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4">An End-To-End Pet Care Marketing Company</h1>
            <p className="text-xl p-4">Pet Care agencies need a provider that covers every aspect of their business. We assign you a dedicated Account Manager to establish goals and develop a timeline to reach them.</p>
        ...
        <div className="flex ml-20 mr-20 gap-10 mt-10">
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-5xl font-bold text-center mb-4">Go Beyond Digital Marketing for Your Pet Care Business</h1>
            <p className="text-xl p-4">Online review generation and reputation management is a vital part of digital marketing for Pet Care agencies. We create a user-friendly application to help you manage your online reputation like never before.</p>
            <p className="text-xl p-4">Take control of your review process and start generating the 5-star reviews you need and quickly address negative feedback right away with this intuitive Pet Care digital marketing tool.</p>
          </div>
          <div className="w-full flex items-center justify-center">
            <img src={petcare} alt="Feedback Management" />
          </div>
        </div>
        ...
        <div className="bg-blue-50 py-16 p-16">
          <div className="container mx-auto">
            <h1 className="text-5xl font-bold text-center mb-16">Pet Care Marketing Services</h1>
     ...
     <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8  ">
      <h1 className='text-center text-5xl font-bold m-4 mb-16 rounded-sm'>Steps to Implement a Pet Care Marketing Strategy</h1>
      ...
      <div className="flex flex-col lg:flex-row justify-evenly items-center gap-8 mt-10 mb-10">
        ...
        <h1 className="text-center text-5xl font-bold mb-10">Pet Care Marketing FAQs</h1>
